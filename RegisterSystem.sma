...
//End of Constants
new cvar_autojoin_team,cvar_autojoin_class;
/*==============================================================================
...
public plugin_init() 
{
	...
	cvar_autojoin_team = register_cvar("us_team", "5")
	cvar_autojoin_class = register_cvar("us_class", "5")
...
/*		static team[2], class[2]
		...
		Force_Team_Join(id, team, class)*/
	}
	return PLUGIN_CONTINUE
}
/*
stock Force_Team_Join(id,  team[] = "5", class[] = "0") 
{
